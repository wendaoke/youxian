...
public interface SessionUserMapper {
	...
	@Select("SELECT session_id as sessionId ,id,openid,nickname,sex,province,city,country,headimgurl,privilege,unionid,lasturl as lastUrl FROM session_user where session_id = #{sessionId} ")
